...
@RestController
@RequestMapping("/api/")//receives jason object from postman
public class CommentController {
    ...
    @PostMapping("/posts/{postId}/comments")//copies data of jaon object to CommentDto
    ...
    //http://localhost:8080/api/posts/postId/comments/2
